...
public class GlobalHandler1 extends Handler {
    private HandleMsgListener listener;
    private String Tag = GlobalHandler.class.getSimpleName();

    //使用单例模式创建GlobalHandler
    private GlobalHandler1(){
        LogUtil.e(Tag,"GlobalHandler创建");
    }

    private static class Holder{
        private static final GlobalHandler1 HANDLER = new GlobalHandler1();
    }

    public static GlobalHandler1 getInstance(){
